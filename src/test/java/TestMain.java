...
//    protected By window = By.id("com.google.android.calculator:id/result_final");
    ...
    @DisplayName("Тест кейс операции сложения")
    @Description("Складываем 1 и 2, ожидаемо получить 3")
    @Test
    ...
    @DisplayName("Тест кейс операции вычитания")
    @Description("Из 10 вычитаем 9, ожидаемо получить 1")
    @Test
    ...
    @DisplayName("Тест кейс операции умножения")
    @Description("Дважды умножаем на 9, затем умножаем на 0, ожидаемо получить 0")
    ...
    @DisplayName("Тест кейс операции деления")
    @Description("Делим 50 на 4, ожидаемо получить 12.5")
    @Severity(SeverityLevel.CRITICAL)
    @Test
